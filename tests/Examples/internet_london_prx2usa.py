...
# proxy3_zone="europe-west3-a" ; proxy3_platform = "gcp" ;proxy3_name= "proxy-k8s1"
# proxy4_zone="fra02"          ; proxy4_platform = "ibm" ;proxy4_name= "proxy-k8s1"
...
# os.system("python3 ./steps/create_k8s_cluster.py -type proxy  -zone {} -platform {} -name {} -bg {}".format(proxy3_zone, proxy3_platform, proxy3_name,True))
# os.system("python3 ./steps/create_k8s_cluster.py -type proxy  -zone {} -platform {} -name {} -bg {}".format(proxy4_zone, proxy4_platform, proxy4_name,True))
...
# os.system("python3 ./steps/set_k8s_cluster.py -type proxy  -zone {} -platform {} -name {}".format(proxy3_zone,proxy3_platform, proxy3_name))
# os.system("python3 ./steps/set_k8s_cluster.py -type proxy  -zone {} -platform {} -name {}".format(proxy4_zone,proxy4_platform, proxy4_name))
...
# check_proxy_target(target_name, target_zone,target_platform,proxy3_name,proxy3_zone,proxy3_platform,time_s)
# check_proxy_target(target_name, target_zone,target_platform,proxy4_name,proxy4_zone,proxy4_platform,time_s)
