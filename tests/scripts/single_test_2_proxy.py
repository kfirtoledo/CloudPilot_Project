################################################################
#Name: single_test
#Desc: Run iperf3 test between 1 host and 1 target via 2 proxies.
...
#        proxy1_zone,proxy1_platform,proxy2_zone,proxy2_platform
################################################################
import os
import argparse
import sys
...
os.system(f"python3 ./steps/run_k8s_test_with_2proxies_several_test.py -p_name1 {proxy_name1} -p_zone1 {proxy_zone1}\
