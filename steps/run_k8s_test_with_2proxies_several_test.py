################################################################
#Name: run_k8s_with_2_proxies
#Desc: Creating iperf3 test from host to target with 2 proxies in the middle .
#      this test:
...
connect_to_cluster(proxy_name1,proxy_zone1,proxy_platform1)
run_single_iperf_test(proxy_name1, host_name,   host_ip,   host_port,   res_dir, type_data="direct")
...
run_multiple_iperf_test(host_name, proxy_name1,  forwarding_ip1, forwarding_port1, res_dir, type_data="forwarding",nof_tests=20,time=5)
run_multiple_iperf_test(host_name, proxy_name1,  proxy_ip1,     proxy_port1,      res_dir, type_data="proxy",nof_tests=20,time=40)