...
from aux_func.network_test_func import run_single_iperf_test, connect_to_cluster, get_folder_res
import sys,os
...
run_single_iperf_test(host_name, target_name, target_ip,    target_port,     res_dir, type_data="direct")
run_single_iperf_test(host_name, proxy_name,  proxy_ip,     proxy_port,      res_dir, type_data="proxy")
run_single_iperf_test(host_name, proxy_name,  forwarding_ip, forwarding_port, res_dir, type_data="forwarding")